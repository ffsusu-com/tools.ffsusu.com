                ...
                if(isset(getfor_1)){
                    for (var j = 1; j < csvList_npc.length; j++) {
                        if (csvList_npc[j][0]==getfor_1) {
                            ...
                            if ( csvList_npc[j][3] != '' ) {
                                insert3 += '<br>　　→<p class="color_orange">ET' + csvList_npc[j][3] + '</p>';
                            };
                        };
                    }
                }
...
function saveNpcdata(){
    ...
    //配列をクッキー保存
    $.cookie("dataNpc",npcArray, { expires: 365 , path: "/tripletryad_list.html" });
}
...
function saveCard1data(){
    ...
    //配列をクッキー保存
    $.cookie("dataCard1",card1Array, { expires: 365 , path: "/tripletryad_list.html" });
}
...
function saveCard2data(){
    ...
    //配列をクッキー保存
    $.cookie("dataCard2",card2Array, { expires: 365 , path: "/tripletryad_list.html" });
}
...
function saveCard3data(){
    ...
    //配列をクッキー保存
    $.cookie("dataCard3",card3Array, { expires: 365 , path: "/tripletryad_list.html" });
}
...
function saveCard4data(){
    ...
    //配列をクッキー保存
    $.cookie("dataCard4",card4Array, { expires: 365 , path: "/tripletryad_list.html" });
}
...
function saveCard5data(){
    ...
    //配列をクッキー保存
    $.cookie("dataCard5",card5Array, { expires: 365 , path: "/tripletryad_list.html" });
}