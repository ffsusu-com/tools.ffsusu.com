    ...
    loadStep: function(params){
      ...
      var baseHtml =  "<div class='ystep-container'>"+
                        ...
                        "<div class='ystep-progress'>"+
                          "<p class='ystep-progress-bar' style='padding: 0px 0px 0px 0px;'>"+
                            "<span class='ystep-progress-highlight'  style='width:0%;padding: 0px 0px 0px 0px; '>"+
                            "</span>"+
                          "</p>"+
                        "</div>"+
                      "</div>";
        ...
        if(1<=step && step<=$steps.length){
          ...
          $progress.animate({
            ...
            speed: 1000,
              ...
              //移动节点
              $steps.each(function(j2,m2){
                var _$m2 = $(m2);
                var _j2 = j2+1;
                if(_j2 < step){
                  _$m2.attr("class","ystep-step-done");
                }else if(_j2 === step){
                  _$m2.attr("class","ystep-step-active");
                }else if(_j2 > step){
                  _$m2.attr("class","ystep-step-undone");
                }
              });
            }
          });
