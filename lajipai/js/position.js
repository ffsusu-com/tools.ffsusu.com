...
function back() {
    $('#page').remove();    
    $('#main').append(
        '<div id="left" style="opacity: 0;"><ul style="padding-top: 30px;" id="item"></ul></div>'
        , '<div id="right" style="opacity: 0;"><ul id="notice_title"></ul><ul id="notice" style="height:199px;"></ul><ul id="update_title"></ul><ul id="update_log"></ul></div>'
    );
    if (document.documentElement.clientWidth - 1004 > 40) {
        $("#right").css("width", 327);
        $("#right").css("visibility", "visible");
