        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 1; i < csvList.length; i++) {
                    if (i % 100 == 1) {
                        insert = '<li><a class="btn" onclick="emoteexplain(' + i + ')" target="_blank"><img src="image/emote/' + csvList[i][6] + '.png" onerror=this.src="image/emote/064000.tex.png" onload="image(this)">';
