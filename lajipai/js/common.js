...
function load() {
    $('#item').append(
        ...
        , '<li><a onclick="dungeons()"><img style="animation-delay:0.7s;" src="image/副本开启.png"><div><p class="buff" style="color: orange;">Update</p></div></a><p>副本开启</p></li>'
        , '<li><a onclick="jobtask()"><img style="animation-delay:0.8s;" src="image/职业任务.png"><div></div></a><p>职业任务</p></li>'
        , '<li style="margin-right: 300px;"><a onclick="music()"><img style="animation-delay:0.9s;" src="image/乐谱.png"><div><p class="buff" style="color: orange;">Update</p></div></a><p>乐谱</p></li>'
        , '<li><a onclick="dig()"><img style="animation-delay:0.8s;" src="image/藏宝图.png"><div></div></a><p>藏宝图</p></li>'
        , '<li><a onclick="explore()"><img style="animation-delay:0.9s;" src="image/探索笔记.png"><div></div></a><p>探索笔记</p></li>'
        , '<li><a onclick="emote()"><img style="animation-delay:1s;" src="image/表情一览.png"><div><p class="buff" style="color: orange;">Update</p></div></a><p>表情一览</p></li>'
        , '<li style="margin-right: 200px;"><a onclick="hunt()"><img style="animation-delay:1.1s;" src="image/狩猎.png"><div></div></a><p>狩猎</p></li>'
      //   , '<li><a onclick="bluemagic()"><img style="animation-delay:0.9s;" src="image/青魔.png"><div></div></a><p>青魔法书</p></li>'
        ...
        , '<li><a onclick="fateshop()"><img style="animation-delay:1.1s;" src="image/危命商人.png"><div></div></a><p>危命商人</p></li>'
        , '<li><a onclick="niaojia()"><img style="animation-delay:1.2s;" src="image/鸟甲.png"><div><p class="buff" style="color: orange;">Update</p></div></a><p>鸟甲一览</p></li>'
        , '<li style="margin-right: 100px;"><a><img style="animation-delay:1.3s;filter: grayscale(100%)" src="image/蛮族兑换.png"><div></div></a><p>蛮族兑换</p></li>'
