        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 1; i < csvList.length; i++) {
                    if (i % 100 == 1) {
                        insert = '<li><a class="btn" onclick="petexplain(' + i + ')" target="_blank"><img src="image/chongwuzuoqi-ui/' + csvList[i][1] + '.png" onerror=this.src="image/chongwuzuoqi-ui/004500.tex.png" onload="image(this)">';
