...
function exploreexplain(obj, i) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            insert += '<img onclick="bigger(this)" style="float:right;width:112px;height:63px;" src=image/explore/' + csvList[i][16] + '.jpg onload="image(this)">';
            insert += '<img onclick="bigger(this)" style="position: relative;float:right;width:112px;height:63px;right:10px;" src=image/explore/' + csvList[i][15] + '.jpg onload="image(this)"></p>';
