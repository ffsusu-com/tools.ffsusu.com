function aether() {
    ...
    $(function () {
        ...
        insert2 += '<img alt="" src="https://ww1.sinaimg.cn/mw690/74ed1823gw1exa9neuhybj205d01n74x.jpg" style="width: 193px; height: 59px;opacity: 1;" /><br />'
        ...
        $.ajax({
            ...
            success: function (data) {
                infolist[1] = "";
                infolist[2] = "";
                infolist[1] += '<li><a class="btn" onclick="aetherexplain(this,1)" target="_blank"><img src="image/aether/1.png"><div style="background-image: url("");" class="bd"></div></a></li>';
                infolist[1] += '<li><a class="btn" onclick="aetherexplain(this,2)" target="_blank"><img src="image/aether/2.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[1] += '<li><a class="btn" onclick="aetherexplain(this,3)" target="_blank"><img src="image/aether/3.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[1] += '<li><a class="btn" onclick="aetherexplain(this,4)" target="_blank"><img src="image/aether/4.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[1] += '<li><a class="btn" onclick="aetherexplain(this,5)" target="_blank"><img src="image/aether/5.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[1] += '<li><a class="btn" onclick="aetherexplain(this,6)" target="_blank"><img src="image/aether/6.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[2] += '<li><a class="btn" onclick="aetherexplain(this,7)" target="_blank"><img src="image/aether/7.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[2] += '<li><a class="btn" onclick="aetherexplain(this,8)" target="_blank"><img src="image/aether/8.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[2] += '<li><a class="btn" onclick="aetherexplain(this,9)" target="_blank"><img src="image/aether/9.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[2] += '<li><a class="btn" onclick="aetherexplain(this,10)" target="_blank"><img src="image/aether/10.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[2] += '<li><a class="btn" onclick="aetherexplain(this,11)" target="_blank"><img src="image/aether/11.png"><div style="background-image: url(""); class="bd"></div></a></li>';
                infolist[2] += '<li><a class="btn" onclick="aetherexplain(this,12)" target="_blank"><img src="image/aether/12.png"><div style="background-image: url(""); class="bd"></div></a></li>';
...
function aetherexplain(obj, i) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            csvList = $.csv()(data);
            csvList[i][0] == "" ? insert += '<p style="font-size: 19px;">全部由主线触发</p>' : insert += '<img onclick="bigger(this)" style="float:left;width:340px;"src="image/aether/' + csvList[i][0] + '.jpg">';
