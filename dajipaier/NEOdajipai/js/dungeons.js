function dungeons() {
    ...
    $(function () {
        ...
        , '<ul id="page_item"><li id="page_item_left" style="width: 500px;border-right: 1px solid rgba(42,42,41,1);box-shadow: 1px 1px 0px rgba(67,67,67,1);"><ul style="width: 500px;top:0px;text-align: center;" id="dungeonstype"></ul><ul style="width: 500px;top:0px;padding-top: 20px;" id="music"></ul></li><li id="page_item_right" style="width: 450px;"></li></ul>'
        );
        $('#page_itemtop').append(
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 1; i < csvList.length; i++) {
                    var num = csvList[i][7] + csvList[i][8];
...
function dungeonsexplain(obj, i) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            insert += '<p style="float:left;">等级：</p><p style="color: #FFC125;font-weight: bold;">' + csvList[i][6] + '</p>';
            insert += '<p style="float:left;">装等：</p><p style="color: #FFC125;font-weight: bold;">' + csvList[i][5] + '</p>';
            insert += '<p style="float:left;">任务：</p><p style="color: #FFC125;font-weight: bold;">' + csvList[i][3] + '</p>';
            insert += '<p style="float:left;">位置：</p><p style="color: #FFC125;font-weight: bold;margin-bottom: 10px;">' + csvList[i][4] + '</p>';                       
