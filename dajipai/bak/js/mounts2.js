function mounts() {
    ...
    $(function () {
        ...
        var insert = '';        
        $(".link").empty();
        $(".link").append('<div id="pagenum" class="pagenum"></div><ul id="mounts"></ul>');
        $(".explain").empty();
        $.ajax({
            url: './csv/mounts.csv',
            success: function (data) {
                ...
                for (var i = 1; i < csvList.length; i++) {
                    if (i % 40 == 1) { insert = '<li><a class="btn" onclick="mountexplain(' + i + ')" target="_blank"><img src="tupian/chongwuzuoqi-ui/' + csvList[i][1] + '.png" onerror=this.src="tupian/chongwuzuoqi-ui/004400.tex.png"><div class="bd"></div></a></li>'; }
                    else { insert += '<li><a class="btn" onclick="mountexplain(' + i + ')" target="_blank"><img src="tupian/chongwuzuoqi-ui/' + csvList[i][1] + '.png" onerror=this.src="tupian/chongwuzuoqi-ui/004400.tex.png"><div class="bd"></div></a></li>'; }
                    if (i % 40 == 0)
