    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 1; i < csvList.length; i++) {
                if (i % 40 == 1) { insert = '<li><a class="btn" onclick="explain(' + i + ')" target="_blank"><img src="tupian/chongwuzuoqi-ui/' + csvList[i][1] + '.png" onerror=this.src="tupian/chongwuzuoqi/004500.tex.png"><div class="bd"></div></a></li>'; }
                else { insert += '<li><a class="btn" onclick="explain(' + i + ')" target="_blank"><img src="tupian/chongwuzuoqi-ui/' + csvList[i][1] + '.png" onerror=this.src="tupian/chongwuzuoqi/004500.tex.png"><div class="bd"></div></a></li>'; }
                if (i % 40 == 0)
...
function explain(i) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            csvList[i][6] == "" ? insert += '<p>目前不明</p>' : insert += '<p style="color:#696969;">' + csvList[i][6] + '</p>';
